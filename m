...
:root {
  /* ACCENT COLORS */
  --main-color: #DF73FF; /* main accent color (hex, rgb or hsl) [default: #2780e6] */
  --hover-color: rgba(222, 115, 255, 0.863); /* hover accent color (hex, rgb or hsl) [default: #1e63b3] */
  --success-color: #43b581; /* success accent color (hex, rgb or hsl) [default: #43b581] */
  --danger-color: #FF7F50; /* danger accent color (hex, rgb or hsl) [default: #982929] */
  ...
  --background-image: url(https://4kwallpapers.com/images/wallpapers/macos-monterey-wwdc-21-stock-dark-mode-5k-3840x2160-5585.jpg); /* app background image (link must be HTTPS) [default: url(https://clearvision.github.io/images/sapphire.jpg)]*/
  ...
  --background-blur: 5px; /* app background blur [default: 0px] */
